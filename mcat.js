...
const mcatItems = [
  ...
  },
  {
    ...
    proposed: [{ h: "Question format" }, { pills: ["All", "Passage-based", "Discrete"], hi: [1, 2], firstOn: true }, { h: "Question type" }, { pills: ["All", "Unattempted", "Previously Incorrect", "Bookmarked"] }],
    ...
    rationale: "Verified in components/evaluation/QuestionTypePills.tsx:19-30 and utils/course.ts. MCAT shares NCLEX's format list, but every MCAT question is a four-option multiple choice, either in a passage set or standalone, so each pill empties the list. The MCAT has two formats, both four-option multiple choice: passage-based sets (about 75% of the exam) and standalone questions. AAMC says “passage-based and independent questions”; Blueprint says “passage-based” and “Discretes”. Image Based is not gated by course here even though By Subject hides it. Engineering check: this only works if MCAT questions are tagged as passage or standalone in the question bank (no MCAT sample data in the repo to confirm).",
  },
  {
